...
<body>';
	...
	<div id="content">
	<p><font face="Imprint MT Shadow" size="5" color="blue"><center>Please Enter Text for Your Message: </center>
	<form action="text_only_post.php" method="post" align="center">
	<textarea name="post_text" rows=5 cols=100></textarea>
	<br><br>
	Batch: <input type="text" placeholder="Optional" name="batches">
	<input type="submit" value="Submit Text!" name="submit" align="right">
	</form>
